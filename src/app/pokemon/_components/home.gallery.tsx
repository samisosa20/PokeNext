...
import { galleryController, HomePageContentProps, SearchCriteria } from '@/hooks/pages';


export default function HomePageContent({ initialAllPokemon }: HomePageContentProps) {

    const {searchCriteria, setSearchCriteria, setEvolutionSearchResults, getSearchPlaceholder, searchTerm, setSearchTerm, currentOverallLoadingState, isEvolutionSearchLoading, pokemonToDisplay, debouncedSearchTerm, noResultsMessageText, handleReset, allPokemon} = galleryController({ initialAllPokemon })
